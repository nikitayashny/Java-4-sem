...
<div style="display: flex; background-color: white">
    ...
    <fieldset>
        ...
        <form action="UpdateSubjectServlet" method="POST">
            <input name="id" type="text" placeholder="New subject name"/> <br/>
            <input name="name" type="text" placeholder="New teacher "/> <br/>
            <input name="teacher" type="text" placeholder="New faculty "/> <br/>
            <input name="faculty" type="text" placeholder="Subject ID to update"/> <br/>
